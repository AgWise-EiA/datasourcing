...
crop_geoSpatial_RelativeHumidity <- function(country, useCaseName, Crop, dataSource, overwrite){
  ...
  if(dataSource == "chirts"){
    pathOut <- paste("/home/jovyan/agwise/AgWise_Data/data_sourcing/UseCase_", country, "_",useCaseName, "/", Crop, "/raw/RelativeHumidity/chirts", sep="")
    listRaster_RH <-list.files(path="/home/jovyan/agwise/AgWise_Data/data_sourcing/Global_GeoData/Landing/RelativeHumidity/chirts", pattern=".nc$")
    listRaster_RH <- terra::rast(paste("/home/jovyan/agwise/AgWise_Data/data_sourcing/Global_GeoData/Landing/RelativeHumidity/chirts", listRaster_RH, sep="/"))
    fileName <- "/chirts_geospatial_RelativeHumidity.tif"
  }else{
    pathOut <- paste("/home/jovyan/agwise/AgWise_Data/data_sourcing/UseCase_", country, "_",useCaseName, "/", Crop, "/raw/RelativeHumidity/AgEra", sep="")
    listRaster_RH <-list.files(path="/home/jovyan/agwise/AgWise_Data/data_sourcing/Global_GeoData/Landing/RelativeHumidity/AgEra", pattern=".nc$")
    listRaster_RH <- terra::rast(paste("/home/jovyan/agwise/AgWise_Data/data_sourcing/Global_GeoData/Landing/RelativeHumidity/AgEra", listRaster_RH, sep="/"))
...
get_RelativeHumidity_pointSummarydata <- function(country, useCaseName, Crop, AOI = FALSE, overwrite = FALSE, 
  ...
  if(dataSource == "chirts"){
    listRaster_RH <-list.files(path="/home/jovyan/agwise/AgWise_Data/data_sourcing/Global_GeoData/Landing/RelativeHumidity/chirts", pattern=".nc$", full.names = TRUE)
  }else if(dataSource == "AgEra"){
    listRaster_RH <-list.files(path="/home/jovyan/agwise/AgWise_Data/data_sourcing/Global_GeoData/Landing/RelativeHumidity/AgEra", pattern=".nc$", full.names = TRUE)
  }
  
  pathOut1 <- paste("/home/jovyan/agwise/AgWise_Data/data_sourcing/UseCase_", country, "_",useCaseName, "/", Crop, "/result/RelativeHumidity", sep="")
  pathOut2 <- paste("/home/jovyan/agwise/AgWise_Data/potential_yield/UseCase_", country, "_",useCaseName, "/", Crop, "/raw/RelativeHumidity", sep="")
  pathOut3 <- paste("/home/jovyan/agwise/AgWise_Data/response_functions/UseCase_", country, "_",useCaseName, "/", Crop, "/raw/RelativeHumidity", sep="")
  ...
  if(AOI == TRUE){
    ...
    if (planting_harvest_sameYear ==  TRUE) {
      ...
      RelativeHumidity_result <- foreach(i=1:length(listRaster_RH), .packages = c('terra', 'plyr', 'stringr','tidyr')) %dopar% {
        ...
        source("~/agwise/AgWise_Scripts/data_sourcing/get_geoSpatialRelativeHumidity_MC.R", local = TRUE)
...
# Extract rainfall data time series for point based data prepared for Crop Models
...
get_geoSpatial_4CropModels <- function(country, useCaseName, Crop, AOI = FALSE, overwrite = FALSE, 
  ...
  pathOut1 <- paste("/home/jovyan/agwise/AgWise_Data/data_sourcing/UseCase_", country, "_",useCaseName, "/", Crop, "/result/",varName, sep="")
  pathOut2 <- paste("/home/jovyan/agwise/AgWise_Data/potential_yield/UseCase_", country, "_",useCaseName, "/", Crop, "/raw/",varName, sep="")
