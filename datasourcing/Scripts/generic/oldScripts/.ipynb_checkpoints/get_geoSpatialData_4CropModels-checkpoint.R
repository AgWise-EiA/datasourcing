...
#################################################################################################################
## function for crop models geospatial data 
#################################################################################################################
...
#'              Planting_month_date = "02-01",  Harvest_month_date = "11-30", jobs=10, id = "TLID")
...
readGeo_CM <- function(country, useCaseName, Crop, AOI = FALSE, Planting_month_date=NULL){
  ...
  if(AOI == TRUE){
    Rainfall <- readRDS(paste(pathIn, "Rainfall/Rainfall_4CM_AOI_", Planting_month_date, "_AgEra.RDS", sep=""))
    SolarRadiation <- readRDS(paste(pathIn, "SolarRadiation/Rainfall_4CM_AOI_", Planting_month_date, "_AgEra.RDS", sep=""))
    TemperatureMax <- readRDS(paste(pathIn, "Temperature/Rainfall_4CM_AOI_", Planting_month_date, "_AgEra.RDS", sep=""))
    Temperaturemin <- readRDS(paste(pathIn, "Temperature/Rainfall_4CM_AOI_", Planting_month_date, "_AgEra.RDS", sep=""))
  ...
  return(list(Rainfall, SolarRadiation, TemperatureMax, TemperatureMin,Soil))
}
