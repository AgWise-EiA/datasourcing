...
crop_geoSpatial_Topography <- function(country, useCaseName, Crop, overwrite){
  ...
  listRaster_dem <-list.files(path="/home/jovyan/agwise-datasourcing/dataops/datasourcing/Data/Landing/Global_GeoData/Topography", pattern=".tif$")
  readLayers_dem <- terra::rast(paste("/home/jovyan/agwise-datasourcing/dataops/datasourcing/Data/Landing/Global_GeoData/Topography", listRaster_dem, sep="/"))
