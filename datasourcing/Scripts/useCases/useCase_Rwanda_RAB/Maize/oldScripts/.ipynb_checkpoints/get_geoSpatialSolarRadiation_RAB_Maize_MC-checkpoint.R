...
source("~/agwise-datasourcing/dataops/datasourcing/Scripts/generic/get_geoSpatialSolarRadiation_MC.R")
...
#################################################################################################################
trial_point_SR_AgEra <- get_SolarRadiation_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", AOI = FALSE,
...
AOI_point_SR_AgEra5 <- get_SolarRadiation_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", AOI = TRUE,
...
#################################################################################################################
#TODO 
AOI_SR_summary_p1 <- get_SolarRadiation_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", 
...
trial_SR_summary_p1 <- get_SolarRadiation_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", 
