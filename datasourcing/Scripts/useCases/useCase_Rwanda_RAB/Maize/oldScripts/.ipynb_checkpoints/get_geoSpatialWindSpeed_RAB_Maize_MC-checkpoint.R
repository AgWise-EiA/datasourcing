...
#################################################################################################################
source("~/agwise-datasourcing/dataops/datasourcing/Scripts/generic/get_geoSpatialWindSpeed_MC.R")
...
#################################################################################################################
trial_point_WS_AgEra <- get_WindSpeed_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", AOI = FALSE,
...
AOI_point_SR_AgEra5 <- get_WindSpeed_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", AOI = TRUE,
...
AOI_WS_summary_p1 <- get_WindSpeed_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", 
...
trial_SR_summary_p1 <- get_WindSpeed_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Maize", 
