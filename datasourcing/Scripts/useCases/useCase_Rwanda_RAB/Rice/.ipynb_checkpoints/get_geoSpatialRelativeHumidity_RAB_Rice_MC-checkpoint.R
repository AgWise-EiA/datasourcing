...
#################################################################################################################
trial_point_RH_AgEra <- get_RelativeHumidity_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = FALSE,
...
AOI_point_RH_AgEra5 <- get_RelativeHumidity_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = TRUE,
...
AOI_RH_summary_p1 <- get_RelativeHumidity_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
...
trial_RH_summary_p1 <- get_RelativeHumidity_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
