...
#################################################################################################################
trial_point_SR_AgEra <- get_SolarRadiation_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = FALSE,
...
AOI_point_SR_AgEra5 <- get_SolarRadiation_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = TRUE,
...
#################################################################################################################
#TODO 
AOI_SR_summary_p1 <- get_SolarRadiation_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
...
trial_SR_summary_p1 <- get_SolarRadiation_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
