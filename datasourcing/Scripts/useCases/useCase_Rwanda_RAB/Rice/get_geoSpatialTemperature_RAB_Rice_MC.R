...
#################################################################################################################
trial_point_Tmax_AgEra <- get_temp_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = FALSE,
                                             overwrite = TRUE, Planting_month_date = NULL,  Harvest_month_date = NULL, 
                                            jobs=10, dataSource = "AgEra", varName = "Tmax", ID="TLID")


trial_point_Tmin_AgEra <- get_temp_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = FALSE, 
                                             overwrite = TRUE,Planting_month_date = NULL,  Harvest_month_date = NULL, 
...
trial_Tmax_summary_p1 <- get_temp_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
                                                   AOI = FALSE, overwrite = TRUE, Planting_month_date = NULL, 
                                                   Harvest_month_date = NULL, jobs=10,
                                                   dataSource = "AgEra", varName = "Tmax", ID="TLID")


trial_Tmin_summary_p1 <- get_temp_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
                                                   AOI = FALSE, overwrite = TRUE, Planting_month_date = NULL, 
                                                   Harvest_month_date = NULL, jobs=10,
...
AOI_point_Tmax_AgEra5 <- get_temp_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = TRUE,
                                   overwrite = TRUE, Planting_month_date = "02-05", 
                                   Harvest_month_date = "06-05", jobs=10, dataSource = "AgEra", varName = "Tmax", ID = NULL)


AOI_point_Tmin_AgEra5 <- get_temp_pointData(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", AOI = TRUE,
                                    overwrite = TRUE, Planting_month_date = "02-05", 
...
AOI_Tmax_summary_p1 <- get_temp_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
                                    AOI = TRUE, overwrite = TRUE, Planting_month_date = "08-08", 
                                    Harvest_month_date = "12-08", jobs=10,
                                    dataSource = "AgEra", varName = "Tmax")


AOI_Tmin_summary_p1 <- get_temp_pointSummarydata(country = "Rwanda",  useCaseName = "RAB", Crop = "Rice", 
                                    AOI = TRUE, overwrite = TRUE, Planting_month_date = "08-08", 
                                    Harvest_month_date = "12-08", jobs=10,
