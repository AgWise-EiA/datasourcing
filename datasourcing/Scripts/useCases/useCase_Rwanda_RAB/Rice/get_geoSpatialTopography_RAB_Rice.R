...
#################################################################################################################
crop_geoSpatial_Topography(country = "Rwanda", useCaseName = "RAB", Crop = "Rice", overwrite = TRUE)


#################################################################################################################
## derive the DEM variables
#################################################################################################################
derive_topography_data(country = "Rwanda",useCaseName = "RAB", Crop = "Rice", overwrite = TRUE)


#################################################################################################################
### extracting topography geo-spatial data for GPS locations (this is essential to get for location we have field/survey data)
#################################################################################################################
RAB_rice_topography_trial <- extract_topography_pointdata(country = "Rwanda", useCaseName = "RAB", Crop = "Rice", AOI = FALSE, ID = "TLID")


#################################################################################################################
## extracting topography geo-spatial data for GPS locations for predictions, for AOI
#################################################################################################################
RAB_rice_topography_AOI <- extract_topography_pointdata(country = "Rwanda", useCaseName = "RAB", Crop = "Rice", AOI = TRUE, ID = NULL)
