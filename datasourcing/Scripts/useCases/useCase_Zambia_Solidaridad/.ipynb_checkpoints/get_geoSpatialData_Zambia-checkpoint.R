...
weather_soil_trial_profile <- extract_geoSpatialPointData(country = "Zambia", useCaseName = "Solidaridad", Crop = "Soybean", 
...
weather_soil_AOI_profileS1 <- extract_geoSpatialPointData(country = "Zambia", useCaseName = "Solidaridad", Crop = "Soybean", 
                                                            AOI=TRUE, Planting_month_date="10-15", Harvest_month_date="05-15", 
                                                            soilData = TRUE, weatherData = TRUE, soilProfile = TRUE, plantingWindow = 7, 
                                                            season = 1, jobs =10)


##$$$$$$$$$ 2. summarized weather data for ML

trial_get_WeatherSummarydata(country = "Zambia", useCaseName = "Solidaridad", Crop = "Soybean", AOI = FALSE, 
                Planting_month_date=NULL, Harvest_month_date=NULL, jobs=10)

AOI_get_WeatherSummarydata(country = "Zambia", useCaseName = "Solidaridad", Crop = "Soybean", AOI = TRUE, 
