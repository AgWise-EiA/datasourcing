...
tefMask <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/cropMask/teff.tif")
tefGrowing <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/growingLength/teff.tif")
tefPlanting <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/sowingDate/teff.tif")
...
PlD_tef <- PlD_date[, c("Zone2", "Teff_Meher")]
