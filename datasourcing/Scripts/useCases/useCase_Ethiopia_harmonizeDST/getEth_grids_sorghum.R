...
sorghumMask <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/cropMask/sorghum.tif")
sorghumGrowing <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/growingLength/sorghum.tif")
sorghumPlanting <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/sowingDate/sorghum.tif")
...
PlD_sorghum <- PlD_date[, c("Zone2", "Sorghum_Meher")]
...
saveRDS(State_LGA2,"~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/Sorghum/raw/sorghum_AOI.RDS")

####################################################################################################
####################################################################################################

### creating the shape file for plating dates, altitude and length of growing season
setwd("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/Sorghum/raw")
...
ETHdem <- raster("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/ETH_dem.tif")



sorghum <- readRDS("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/Sorghum/raw/sorghum_AOI.RDS")
sorghum <- sorghum %>%
