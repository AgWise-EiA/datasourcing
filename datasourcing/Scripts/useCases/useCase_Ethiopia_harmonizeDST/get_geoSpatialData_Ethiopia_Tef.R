...
Crop <- "Tef"
inputDataZ <- readRDS("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/Tef/raw/tef_AOI.RDS")
...
for( zones in unique(inputDataZ$Zone)){
  ...
  pathOut = paste("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/Tef/result/geo_4cropModel/", zones, "/", sep="")
