...
maizeMask <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/cropMask/maize.tif")
maizeGrowing <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/growingLength/maize.tif")
maizePlanting <- terra::rast("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/sowingDate/maize.tif")
...
PlD_Maize <- PlD_date[, c("Zone2", "Maize_Meher")]
...
saveRDS(State_LGA2,"~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/Maize/raw/Maize_AOI.RDS")
...
library(terra)
library(tidyverse)
maize <- readRDS("~/agwise-datasourcing/dataops/datasourcing/Data/useCase_Ethiopia_harmonizeDST/Maize/raw/Maize_AOI.RDS")
maize <- maize %>%
